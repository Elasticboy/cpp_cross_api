...
{
	// Prototypes for Windows specific functions
	 ...
	 */
	ISpRecoGrammar* recognizer::init_grammar(ISpRecoContext* recoContext, const std::string& command)
	{
		HRESULT hr;
		SPSTATEHANDLE sate;
	...
	void recognizer::get_text(ISpRecoContext* reco_context)
	{
